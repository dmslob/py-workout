...
# Expected result: Approximate covariance matrix, hand-verified or via numpy
...
# Expected: A matrix with equal variances and covariances due to linear relationship
